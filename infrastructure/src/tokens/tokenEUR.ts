...
async function main() {
  ...
  try {
    const hodlWallet = await createAndConfigureWallet(client, "sEdTujuwQr4Fxm6CDSEueNHB2bwfHAz");
    const issuerWallet = await createAndConfigureWallet(client, "sEdVQy91BopKK1n2kKa9g5Sv6pbSaMw");
